					...
					<div class="col-xs-12 col-sm-12">
						<div class="post">
							...
							<div class="post-body">
								...
								<hr>
								<p>Duis ultrices tortor non felis convallis bibendum. Maecenas diam velit, sollicitudin
									at imperdiet ac, consectetur non nibh. Etiam eget dapibus nulla.
								</p>
							</div>
					...
					<div class="col-xs-12 col-sm-12">
						<div class="post">
							...
							<div class="post-body">
								...
								<hr>
								<p>Nunc sit amet dapibus est, sit amet varius risus. Donec luctus lacinia mauris, at
									feugiat ligula facilisis ac. Class aptent taciti sociosqu ad litora torquent per
									conubia.
								</p>
							</div>
							<div class="post-footer">
					...
					<div class="col-xs-12 col-sm-12">
						<div class="post">
							...
							<div class="post-body">
								...
								<hr>
								<p>In felis ante, aliquet sit amet venenatis at, feugiat sed leo. Fusce pretium, velit
									in luctus ornare, elit lorem ultrices tortor, sed consectetur orci risus mollis
									ante.
								</p>
							</div>
							<div class="post-footer">
